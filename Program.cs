...
{
    private static readonly string dersDosyaYolu = "dersler.json";
    private static readonly string ogrenciDosyaYolu = "ogrenciler.json";

    private static List<Ders> dersListesi = JsonHelper.LoadFromFile<Ders>(dersDosyaYolu);
    private static List<Ogrenci> ogrenciListesi = JsonHelper.LoadFromFile<Ogrenci>(ogrenciDosyaYolu);
    ...
    {
        dersListesi = JsonHelper.LoadFromFile<Ders>(dersDosyaYolu);
    ...
    private static void YeniDersEkle()
    {
        ...
        JsonHelper.SaveToFile(dersDosyaYolu, dersListesi);
    ...
    private static void YeniOgrenciEkle()
    {
        ...
        JsonHelper.SaveToFile(ogrenciDosyaYolu, ogrenciListesi);
    ...
    {
        ogrenciListesi = JsonHelper.LoadFromFile<Ogrenci>(ogrenciDosyaYolu);
        dersListesi = JsonHelper.LoadFromFile<Ders>(dersDosyaYolu);
